            ...
            <div className="max-w-7xl mx-auto space-y-8 pb-20">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-slate-500 font-medium"> Design a new strategy for your company's growth</p>
                    </div>
                </div>
                ...
                <form onSubmit={submit} className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                        <div className="bg-white p-8 rounded-md border border-slate-100 shadow-sm relative overflow-hidden group">
                            ...
                            <h2 className="text-lg font-bold text-slate-800 mb-6 flex items-center gap-2">
                                <Package className="text-blue-500" size={20} /> BASIC INFORMATION
                            </h2>
                            ...
                            <div className="space-y-5">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        {errors.duration && <p className="mt-2 text-rose-500 text-xs font-bold px-1">{errors.duration}</p>}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    {/* Features Section */}
                    <div className="bg-white p-8 rounded-md border border-slate-100 shadow-sm flex flex-col h-full group">
                         <div className="absolute top-0 left-0 w-32 h-32 bg-emerald-50/30 rounded-br-full opacity-50 -ml-8 -mt-8 transition-transform group-hover:scale-110"></div>
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-lg font-bold text-slate-800 flex items-center gap-2">
                                <Plus className="text-emerald-500" size={20} /> PLAN FEATURES
                            </h2>
                            <button
                                type="button"
                                onClick={addFeature}
